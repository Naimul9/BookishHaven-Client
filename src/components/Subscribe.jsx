...
const Subscribe = () => {
    return (
        <div className='container mx-auto my-10 px-4'>
               <h1 className="mb-10 text-center text-4xl font-bold">Get Our Premium Services</h1>
               <p className="text-center font-medium text-base lg:w-[900px] w-full mx-auto">Discover a world of literary luxury with our premium services. Delve into curated collections tailored to your taste, enjoy personalized book recommendations, and gain access to exclusive author events and signings. Elevate your reading experience and immerse yourself in a realm of unparalleled literary indulgence.</p>
            <header className="bg-base-200  border-2 border-dotted rounded-lg  border-gray-300 mt-5">
    <nav >
     
        <div className="container flex items-center justify-between px-6 py-3 mx-auto">
          
               <div className='flex gap-3 items-center  '> <img className="w-auto h-6 sm:h-7 " src="/logo.gif" alt=""/> 
               <p className='font-extrabold'>Bookish Haven</p></div>
        ...
        <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2">
                <div className="lg:max-w-lg">
                    <h1 className="text-3xl font-semibold text-gray-800 lg:text-4xl">Subscribe To <span className="text-cyan-700">Bookish Haven</span></h1>

                    <p className="mt-3 text-gray-600 dark:text-gray-400">be the first to know when our <span className="font-medium text-green-400">New Books</span> Arrived</p>
                    ...
                    <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                        ...
                        <button className="w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-slate-400 rounded-lg lg:w-auto lg:mx-4 hover:bg-slate-600 focus:outline-none focus:bg-blue-500">
                            Subscribe
                        </button>
                    </div>
                </div>
...
export default Subscribe;<header className="bg-white">
